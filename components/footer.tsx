    ...
    <Container className="flex justify-between border-t border-secondary px-10 py-3">
      ...
      <div className="flex items-center justify-center gap-4">
        <Link href="https://x.com/Deepjyo79836591">
          <IconBrandX className="size-4 text-neutral-600 hover:text-neutral-800" />
        </Link>
        <Link href="https://www.linkedin.com/in/deepjyoti-sarmah-539b96202">
          <IconBrandLinkedin className="size-4 text-neutral-600 hover:text-neutral-800" />
        </Link>
        <Link href="https://github.com/Deepjyoti-Sarmah">
          <IconBrandGithub className="size-4 text-neutral-600 hover:text-neutral-800" />
        </Link>
      </div>
    </Container>
  );
